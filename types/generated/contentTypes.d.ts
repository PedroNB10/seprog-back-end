...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    ...
    >;
    programacaos: Attribute.Relation<
      'api::home.home',
      'oneToMany',
...
export interface ApiOrganizerOrganizer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    shortContent: Attribute.String & Attribute.Required;
    longContent: Attribute.Text & Attribute.Required;
    socialName: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiProgramacaoProgramacao extends Schema.CollectionType {
  collectionName: 'programacaos';
  info: {
    singularName: 'programacao';
    pluralName: 'programacaos';
  ...
  attributes: {
    tabDay: Attribute.String & Attribute.Required;
    organizer: Attribute.String & Attribute.Required;
    theme: Attribute.String & Attribute.Required;
    contentImg: Attribute.Media;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::programacao.programacao': ApiProgramacaoProgramacao;
    }
  }
}
